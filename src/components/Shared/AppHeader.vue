  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:flex-1 space-x-4 lg:justify-end">
        <router-link to="/projects" class="text-sm font-semibold leading-6 text-gray-900">Projects</router-link>
        <router-link to="/aboutMe" class="text-sm font-semibold leading-6 text-gray-900">About Me</router-link>
